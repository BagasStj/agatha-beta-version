...
import AIVoicePage from '../ai-voice/page'
...
export default function Dashboard() {
  ...
  const [currentView, setCurrentView] = useState<'users' | 'chat' | 'email' | 'product' | 'novel' | 'flow' | 'aiphone' | 'chat-flowise' | 'chat-new' | 'ai-voice'>('chat');

  const handleViewChange = (view: 'users' | 'chat' | 'email' | 'product' | 'novel' | 'flow' | 'aiphone' | 'chat-flowise' | 'chat-new' | 'ai-voice') => {
    setCurrentView(view);
  };
      ...
      <div className="flex min-h-screen w-full flex-col bg-muted/40">
        <div className="fixed top-0 left-11 right-0 z-10">
          <HeaderComponent 
            ...
            currentView={currentView as 'users' | 'chat' | 'email' | 'product' | 'novel' | 'flow' | 'aiphone' | 'chat-flowise' | 'ai-voice' }  
